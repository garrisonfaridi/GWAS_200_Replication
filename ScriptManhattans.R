...
tou.ali.blup.bestp    = read.csv("output_200/snp_table_all_aliphatic_pvals.csv")
...
manhattan_single(rs               = gwas.all$rs, # position of each SNP
                 ...
                 outfile          = paste0("output_200/",gwas.name,".png"), # specify location for 
...
# Load table with GWAS p-values combined across all traits for Tou-A 
tou.ind.blup.bestp    = read.csv("output_200/snp_table_all_indolic_pvals.csv")
...
manhattan_single(rs               = gwas.all$rs,
                 ...
                 pval             = gwas.all$p_min,
                 max.y            = 15,
                 outfile          = paste0("output_200/",gwas.name,".png"),
